 ...
 * the dashboard is usable without a Google Places API key. Implements the same
 * ScraperAdapter interface as the live adapter, so the scraper code is uniform.
 *
