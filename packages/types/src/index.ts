// Shared domain types used across the scraper, backend, and frontend.
...
/** Payload the scraper sends to the backend's POST /ingest endpoint. */
...
/** Summary the backend returns after ingesting a scrape. */
